            ...
            <div id="cp">
                <div class="fragment-content">
                    <div>
                        ...
                        $_SERVER{'HTTP_HOST'}; ?>:8080/index.php/medcamp/shutdown"><img
                        src="images/off.png"/>Shutdown</a>
                    </div>
                    <div>
                    ...
                    <div>
                        <a href="http://<?php print
                        $_SERVER{'HTTP_HOST'}; ?>:8080/index.php/medcamp/restore"><img
                        src="images/restore.png"/>Restore Database</a>
                    </div>
                    <div>
                        <a href="https://<?php print
                    ...
                    <div>
                        <a href="http://<?php print
                        $_SERVER{'HTTP_HOST'}; ?>:8080"><img
                        src="images/filemanager.png"/>MedCamp</a>
                    </div>
